...
vamana_sift1M() {
  ...
  ./search_memory_index float fast_l2 sift1M/sift_base.fvecs.bin sift1M.index ${4} sift1M/sift_query.fvecs.bin \
    sift1M/sift_groundtruth.ivecs.bin ${2} sift1M_search_L${1}K${2}T${4}_${3} ${1} > sift1M_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_sift10M() {
  ...
  ./search_memory_index float fast_l2 sift10M/sift10m_base.fvecs.bin sift10M.index ${4} sift10M/sift10m_query.fvecs.bin \
    sift10M/sift10m_groundtruth.ivecs.bin ${2} sift10M_search_L${1}K${2}T${4}_${3} ${1} > sift10M_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_gist1M() {
  ...
  ./search_memory_index float fast_l2 gist1M/gist_base.fvecs.bin gist1M.index ${4} gist1M/gist_query.fvecs.bin \
    gist1M/gist_groundtruth.ivecs.bin ${2} gist1M_search_L${1}K${2}T${4}_${3} ${1} > gist1M_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_crawl() {
  ...
  ./search_memory_index float fast_l2 crawl/crawl_base.fvecs.bin crawl.index ${4} crawl/crawl_query.fvecs.bin \
    crawl/crawl_groundtruth.ivecs.bin ${2} crawl_search_L${1}K${2}T${4}_${3} ${1} > crawl_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_deep1M() {
  ...
  ./search_memory_index float fast_l2 deep1M/deep1m_base.fvecs.bin deep1M.index ${4} deep1M/deep1m_query.fvecs.bin \
    deep1M/deep1m_groundtruth.ivecs.bin ${2} deep1M_search_L${1}K${2}T${4}_${3} ${1} > deep1M_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_deep10M() {
  ...
  ./search_memory_index float fast_l2 deep10M/deep10M_base.fvecs.bin deep10M.index ${4} deep10M/deep10M_query.fvecs.bin \
    deep10M/deep10M_groundtruth.ivecs.bin ${2} deep10M_search_L${1}K${2}T${4}_${3} ${1} > deep10M_search_L${1}K${2}_${3}_T${4}.log 
}
...
vamana_deep100M_1T() {
  ...
  ./search_memory_index float fast_l2 deep100M/deep100M_base.fvecs.bin deep100M.index ${4} deep100M/deep100M_query.fvecs.bin \
    deep100M/deep100M_groundtruth.ivecs.bin ${2} deep100M_search_L${1}K${2}T${4}_${3} ${1} > \
